export const data=[
  ...
  {
    question: "Write the correct HTML tag for the largest heading",
    correctAnswer: "<h1>",
    type: "text"
  },
  // {
  ...
  // },
  // {
  //   question: "Write the CSS property used to change text color",
  //   correctAnswer: "color",
  //   type: "text"
  // },
  // {
  ...
  // },
  // {
  //   question: "Which of the following is used to create responsive web designs?",
  //   option1: "Bootstrap",
  //   option2: "jQuery",
  //   option3: "Node.js",
  //   option4: "PHP",
  ...
  // },
  // {
  //   question: "What JavaScript method is used to add an element at the end of an array?",
  //   correctAnswer: "push",
  //   type: "text"
  // },
  // {
  ...
  // },
  // {
  //   question: "Which technology is used to style web pages in the MERN stack?",
  //   option1: "HTML",
  //   option2: "CSS",
  //   option3: "React",
  //   option4: "MongoDB",
  ...
  // },
  // {
  //   question: "Which backend framework is used in the MERN stack?",
  //   option1: "Django",
  //   option2: "Flask",
  //   option3: "Express.js",
  //   option4: "Laravel",
  ...
  // },
  // {
  //   question: "Write the command to install React using npm",
  ...
  //   option2: "python server.py",
  //   option3: "npm run python",
  //   option4: "npm start",
  //   ans: 4,
  //   type: "multiple"
  // },
